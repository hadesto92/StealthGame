...
// End Cross Module References
	...
	void AFPSPlayerController::OnMissionCompleted(APawn* InstigatoryPawn, bool bMissionSuccess)
	{
		FPSPlayerController_eventOnMissionCompleted_Parms Parms;
		Parms.InstigatoryPawn=InstigatoryPawn;
	...
	{
		static const UECodeGen_Private::FObjectPropertyParams NewProp_InstigatoryPawn;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AFPSPlayerController_OnMissionCompleted_Statics::NewProp_InstigatoryPawn = { "InstigatoryPawn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPSPlayerController_eventOnMissionCompleted_Parms, InstigatoryPawn), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFPSPlayerController_OnMissionCompleted_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFPSPlayerController_OnMissionCompleted_Statics::NewProp_InstigatoryPawn,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFPSPlayerController_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFPSPlayerController_OnMissionCompleted, "OnMissionCompleted" }, // 773866311
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_StealthGame_Source_FPSGame_Public_FPSPlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StealthGame_Source_FPSGame_Public_FPSPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFPSPlayerController, AFPSPlayerController::StaticClass, TEXT("AFPSPlayerController"), &Z_Registration_Info_UClass_AFPSPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFPSPlayerController), 147512660U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_StealthGame_Source_FPSGame_Public_FPSPlayerController_h_3119109048(TEXT("/Script/FPSGame"),
		Z_CompiledInDeferFile_FID_StealthGame_Source_FPSGame_Public_FPSPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_StealthGame_Source_FPSGame_Public_FPSPlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
