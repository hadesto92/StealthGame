...
AFPSBlackHole::AFPSBlackHole()
{
	...
	InnerSphereComponent = CreateDefaultSubobject<USphereComponent>(TEXT("InnerSphereComp")); //ma³a sfera odpowiedzialna za to aby znalezione komponenty do niej lecia³y a po zetkniêciu siê z ni¹ zosta³y usuniête
	...
	OuterSphereComponent = CreateDefaultSubobject<USphereComponent>(TEXT("OuterSphereComp"));  //Utorzenie sfery która bêdzie szuka³a odpowiednich komponentów
